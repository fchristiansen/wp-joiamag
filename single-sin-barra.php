      ...
      <div class="site-content">
        ...
        <article class="single-page single-page-no-sidebar">
          <div class="container">
            ...
            <img class="d-block img-fluid" src="<?php bloginfo('template_url'); ?>/assets/img/single-carousel.jpg" alt="">
            ...
            <div class="image-visual with-caption">
              <div class="row justify-content-md-center">
                <div class="col col-md-8">
                  <img class="img-fluid" src="<?php bloginfo('template_url'); ?>/assets/img/single-page.jpg" alt="">
            ...
            <div class="text-block">
              <div class="row justify-content-md-center">
                <div class="col col-md-8">
                  ...
                  <h2 class="text-center">Curabitur vitae varius arcu.</h2>
                  <p>Aliquam semper augue turpis, vitae egestas leo euismod eget. Vestibulum mauris ex, aliquet sit amet enim nec, mattis commodo leo. Aenean at libero convallis, accumsan arcu et, porta purus. Curabitur tortor erat, ultricies at eros quis, dignissim tincidunt orci. Proin sodales nulla sit amet ex rhoncus finibus. at volutpat. Morbi porta aliquet sodales. Suspendisse luctus neque at magna elementum consequat. Nulla feugiat sapien sed condimentum accumsan. Nunc sagittis justo augue, non tempor purus ultrices a.</p>
                </div>
              </div>
            </div>
          </div>
