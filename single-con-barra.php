            ...
            <div id="carousel-02" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                  <img class="d-block img-fluid" src="<?php bloginfo('template_url'); ?>/assets/img/single-carousel.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block img-fluid" src="<?php bloginfo('template_url'); ?>/assets/img/single-carousel.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block img-fluid" src="<?php bloginfo('template_url'); ?>/assets/img/single-carousel.jpg" alt="Third slide">
                </div>
              </div>
                ...
                <section class="sidebar">
                  <div class="widget popular-posts">
                    ...
                    <article class="teaser">
                      <div class="media">
                        <a class="d-flex mr-3" href="javascript:void(0);">
                          <img src="<?php bloginfo('template_url'); ?>/assets/img/thumb.jpg" alt="Generic placeholder image">
                        </a>
                        <div class="media-body">
                          <div class="cat">
                            <a href="javascript:void(0);">Musica</a>
                          </div>
                          <h5 class="mt-0 mb-0">
                  ...
                  <div class="">
                    <img class="img-fluid" src="http://placehold.it/350x600">
                  </div>
