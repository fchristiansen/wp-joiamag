      ...
      <div class="page page-content page-resultados">
        <div class="container">
          <div class="page-heading-title page-heading-title-tienda">
            ...
            <section class="section pedido-procesado">
                <p class="texto_confirmacion">Pedido Procesado : )</p>
                <div class="row no-gutters box_gris">
                      ...
                      <p class="texto_indicacion">
                        Realiza una transferencia por el total de tu compra a la cuenta que detallamos a continuación: 
                        <p class="texto_bold_centrado">
                        Productora Fierro y Bahamonde Ltda. <br>    
                        Rut: 76.037.079-7 <br>    
                        Cuenta corriente 29538122 <br>    
                        Banco BCI 
                        </p>
                        <p class="texto_indicacion">Envía el comprobante de la transferencia junto al número de tu orden de compra y tu pedido será ingresado. <br>
                        Te notificaremos via correo electrónico. </p>
                      </p>
                          <div class="text-center">
                              <a href="javascript:void(0);" role="button" class="btn btn-primary btn_negro btn_compra">Webpay</a>
                          </div>
