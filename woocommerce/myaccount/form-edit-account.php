...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" id="datos_cliente">

	<?php do_action( 'woocommerce_edit_account_form_start' ); ?>
	<div class="caja_gris">Usuario:</div>
	...
	<p>
		...
		<input type="submit" class="woocommerce-Button button btn btn-primary btn_form_gris" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>" />
